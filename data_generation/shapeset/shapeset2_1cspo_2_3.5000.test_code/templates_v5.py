...
def one_object_questions_shape_no_location(cl,sh): 

   #6. A color object is in hor vert. What is its shape?
   #7. Is an object in the top or bottom?     
   	article= choose_article(cl)
		
        sentenceOut = ['What '+ VERB[0]+ ' ' + DETERMIN[0] + ' shape ' + spacePREPOSITION[1] + ' ' + DETERMIN[0] + ' ' + cl +' object?'+' '+sh, DETERMIN[1]+' '+ VERB[0]+' ' + article +' '+ cl + ' object.' + ' '+'What '+VERB[0]+' '+PRONOUN[2]+ ' shape? '+sh, DETERMIN[1]+' '+ VERB[0]+' ' + article +' ' + cl + ' object. What shape' + ' '+ VERB[0]+' '+PRONOUN[0] +'?'+' '+sh]
	
   	return sentenceOut 

def one_object_questions_same_shape(sh): 

   #6. A color object is in hor vert. What is its shape?
   #7. Is an object in the top or bottom?     
	
        sentenceOut = ['What'+' '+ VERB[0]+' '+DETERMIN[0]+' '+'shape'+' '+spacePREPOSITION[1]+' '+DETERMIN[0] +' '+ 'objects' +'?'+' '+sh,		 
	 DETERMIN[1]+' '+ VERB[1]+' '+'objects'+ '. '+ ' '+'What'+' '+VERB[0]+' '+PRONOUN[4]+' '+'shape' +'?'+' '+sh]
...
def one_object_questions_color_no_location(cl,sh): 
      # templates 
...
def one_object_questions_same_color(cl): 

   #6. A color object is in hor vert. What is its shape?
   #7. Is an object in the top or bottom?     
  	
        sentenceOut = ['What'+' '+ VERB[0]+' '+DETERMIN[0]+' '+'color'+' '+spacePREPOSITION[1]+' '+DETERMIN[0] +' '+ 'objects' +'?'+' '+cl,		 
	 DETERMIN[1]+' '+ VERB[1]+' '+'objects'+ '. '+ ' '+'What'+' '+VERB[0]+' '+PRONOUN[4]+' '+'color' +'?'+' '+cl]
...
def two_objects_questions_shape_sameLocation(cl1,sz1,sh1,obj2,obj2t,relposition): 
      # templates 
	...
	if sz1 in ['medium','NA']: 
        ...
        sentenceOut = [ DETERMIN[1]+' '+VERB[0]+' '+ article+' '+sz1+' '+cl1+' '+'object' + ' ' +relposition + ' '+obj2 +'.'+' '+'What'+' '+ VERB[0]+' '+ PRONOUN[2] + ' ' + 'shape' + '?' + ' '+sh1]
...
def two_objects_questions_location_hor (obj1,obj1t,obj2,obj2t,relposition): 
      # templates 
...
def two_objects_questions_location_hor_abs(obj1,obj1t,obj2,obj2t,relposition,abspos): 
      # templates 
...
def two_objects_questions_location_vert (obj1,obj1t,obj2,obj2t,relposition): 
      # templates 
	...
	if vert_choice == '1':
        ...
        sentenceOut = [VERB[2]+' '+ obj1t  + ' ' + vert1 + ' '+ DISJUNCTION[0] +' '+vert2 +' '+obj2t+'?'+' ' +relposition]
...
def two_objects_questions_location_vert_abs (obj1,obj1t,obj2,obj2t,relposition,absp): 
	...
	if vert_choice == '1':
        ...
        sentenceOut = [ obj1 + ' ' + VERB[0] + ' ' + absp +'.'+' '+ VERB[2]+' '+ PRONOUN[0]   + ' ' + vert1 + ' '+ DISJUNCTION[0]  +' '+ vert2 +' '+obj2t+'?'+' ' +relposition]
		
	return sentenceOut 


def two_objects_questions_size(cl1,sh1,cl2,sh2,relposition,relsize): 
	
      	article = choose_article(cl1)
	article1 = choose_article(cl2)
        sentenceOut = [ VERB[2]+' '+DETERMIN[0] +' '+ cl1 +' ' + sh1  + ' ' + COMPSIZE[0] + ' '+ DISJUNCTION[0] +' '+COMPSIZE[1] +' '+ DISJUNCTION[1]+' '+' the '+cl2 +' ' + sh2+'?'+' ' +relsize,
	article +' '+ cl1 +' ' + sh1 + ' ' + VERB[0] + ' ' + relposition + ' '+ article1 + ' '+cl2 + ' '+ sh2 +'.'+' '+ VERB[2]+' '+ PRONOUN[0]   + ' ' + COMPSIZE[0] + ' '+ DISJUNCTION[0]  +' '+ COMPSIZE[1] +' '+ DISJUNCTION[1]+' '+' the '+cl2 +' ' + sh2+'?'+' ' +relsize]
		
	return sentenceOut 

def two_objects_questions_size_abspos (cl1,sh1,cl2,sh2,abspos,relsize): 
      
	  
        sentenceOut = [ article +' '+ cl1 +' ' + sh1 + ' ' + VERB[0] + ' ' + abspos +'.'+' '+ VERB[2]+' '+ PRONOUN[0]   + ' ' + COMPSIZE[0] + ' '+ DISJUNCTION[0]  +' '+ COMPSIZE[1] +' '+ DISJUNCTION[1]+' the '+cl2 +' ' + sh2+'?'+' ' +relsize]
